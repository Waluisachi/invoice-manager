...
let invoices, invoice;
  export default {
    setup() {
      ...
      const invoiceNumber = computed(() => route.params.number)
      console.log(invoiceNumber);

      onMounted(async () => {
         invoice = invoices.find(invoice => invoice.number === invoiceNumber);
      ...
      const update = () => {
        invoice.splice(invoices.findIndex(invoice => invoice.number == invoiceNumber ), 1, {...form});
      ...
      return { form, create, deleteInvoice, update };
    },
